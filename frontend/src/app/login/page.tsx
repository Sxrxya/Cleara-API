...
export default function LoginPage() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            toast.success("Welcome back to Cleara!");
    ...
    return (
        <div className="min-h-screen flex">
            ...
            <div className="hidden lg:flex flex-1 bg-gradient-to-br from-primary-500 via-primary-600 to-success-500 p-12 items-center justify-center relative overflow-hidden">
                {/* Animated Background */}
                ...
                <div className="relative z-10 text-white max-w-lg space-y-8">
                    ...
                    <p className="text-xl text-white/90">
                        Join thousands of developers using Cleara to validate, clean, and
                        enrich their data with powerful AI models.
                    </p>
                    <div className="space-y-4">
                        ...
                        <div className="flex items-center space-x-3">
                            ...
                            <span className="text-lg">Sub-200ms latency</span>
                        </div>
                        <div className="flex items-center space-x-3">
                            <div className="w-8 h-8 bg-white/20 rounded-lg flex items-center justify-center">
                                ✓
